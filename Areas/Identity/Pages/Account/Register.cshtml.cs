...
namespace RazorEF.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "{0} must be at least {2} and at max {1} charaters long.", MinimumLength = 2)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // /confirm-email?userId=..&code=...&returnUrl=...
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Confirm your email",
                        $"Successfully register. Please confirm your account by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");

                    // 10.3 RequireConfirmedAccount = false, auto SignIn. If true, redirect to RegisterConfirmation
